...
The repository contains my implementation of the To-Do list app. inspired by the first brazilian live coding of the [React 
Nanodegree Program](https://udacity.com/course/react-nanodegree--nd019). 
This is a simple To-Do list app done in React. It saves task on browser local storage only.

![](https://raw.githubusercontent.com/computationalcore/react-to-do-list/gh-pages/to-do-list.gif)
